 ...
 * <df:addCssFile cssFile="{f:uri.resource(path: 'StyleSheets/Common.css')}" />
 *
 * @author Stefan Galinski <sgalinski@df.eu>
 * @package df_tools
 */
class Tx_DfTools_ViewHelpers_AddCssFileViewHelper extends Tx_DfTools_ViewHelpers_AbstractViewHelper {
	/**
