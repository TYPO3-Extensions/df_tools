 ...
 * @subpackage df_tools
 */
class tx_DfTools_ExtensionManager_FlexForm {

	const virtualTable = 'tx_dftools_configuration';
	const virtualRecordId = 1;
	const virtualConfigurationFile = 'Configuration/ExtensionManager/VirtualConfigurationTable.php';

	/**
	 * @var string
	 */
	protected $extKey = 'df_tools';

	/**
	 * @var array
	 */
	protected $expertKey = 'df_tools';
	...
	protected function buildForm(array $row) {
		...
		global $TCA;
		require_once(t3lib_extMgm::extPath('df_tools') . self::virtualConfigurationFile);
