 ...
 * @package df_tools
 */
class Tx_DfTools_Controller_RedirectTestCategoryControllerTest extends Tx_DfTools_Tests_ControllerTestCase {
	/**
	...
	public function testInjectRedirectTestCategoryRepository() {
		...
		$repository = new Tx_DfTools_Domain_Repository_RedirectTestCategoryRepository;
	...
	public function readWithoutFilterFindAllResults() {
		...
		$mockRepository = $this->getMock($class, array('findAll'));
	...
	public function readWithFilterStringFindsCategoriesStartingWithTheFilterString() {
		/** @noinspection PhpUndefinedMethodInspection */
		$class = 'Tx_DfTools_Domain_Repository_RedirectTestCategoryRepository';
		$mockRepository = $this->getMock($class, array('findByStartingCategory'));
	...
	public function deleteAllUnusedCategoriesMethodRemovesCategories() {
		...
		/** @noinspection PhpUndefinedMethodInspection */
		$class = 'Tx_DfTools_Domain_Repository_RedirectTestCategoryRepository';
		$mockRepository = $this->getMock($class, array('findAllUnusedCategories', 'remove'));
	...
	public function updateActionUpdatesCategory() {
		...
		/** @noinspection PhpUndefinedMethodInspection */
		$class = 'Tx_DfTools_Domain_Repository_RedirectTestCategoryRepository';
		$mockRepository = $this->getMock($class, array('update'));
