...
/**
 * Test case for class Tx_DfTools_Domain_Repository_LinkCheckRepository.
 *
 * @author Stefan Galinski <sgalinski@df.eu>
 * @package df_tools
 */
class Tx_DfTools_Domain_Repository_LinkCheckRepositoryTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function findSortedInRangeWithNonIntegerRangeThrowsNoException() {
		...
		$this->fixture->findSortedAndInRange('10', '20', 'field1', TRUE);
	}
	 ...
	 * @return void
	 */
	public function findSortedInRangeWithEmptyField() {
		/** @noinspection PhpUndefinedMethodInspection */
		$mockQuery = $this->prepareFindSortedInRangeTests();
		$mockQuery->expects($this->never())->method('setOrderings');
		$this->fixture->findSortedAndInRange(0, 200, '', TRUE);
	}
	...
	public function findSortedInRangeWithValidValues() {
		...
		$this->fixture->findSortedAndInRange(0, 200, 'field1', TRUE);
	}
	...
	public function findSortedInRangeWithDescendingSortingDirection() {
		...
		$this->fixture->findSortedAndInRange(0, 200, 'field1', FALSE);
	}
}
