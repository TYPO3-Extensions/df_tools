 ...
 * @package df_tools
 */
class Tx_DfTools_ViewHelpers_AddJavaScriptFileViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * Fixture
	 *
	...
	public function setUp() {
		$this->fixture = new Tx_DfTools_ViewHelpers_AddJavaScriptFileViewHelper();
	}
	...
	public function javascriptFileCanBeAdded() {
		...
		$pageRenderer = $this->getMock(
			't3lib_PageRenderer',
			array('addJsFile'), array(), '', FALSE, FALSE, FALSE
		);

		/** @noinspection PhpUndefinedMethodInspection */
		$pageRenderer->expects($this->once())
			->method('addJsFile')
			->with('this/is/my/file.js');
