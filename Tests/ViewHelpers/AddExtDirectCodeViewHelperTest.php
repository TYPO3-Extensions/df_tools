 ...
 * @package df_tools
 */
class Tx_DfTools_ViewHelpers_AddExtDirectCodeViewHelperTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * Fixture
	 *
	...
	public function setUp() {
		$this->fixture = new Tx_DfTools_ViewHelpers_AddExtDirectCodeViewHelper();
	}
	...
	public function extDirectCodeCanBeAdded() {
		...
		$pageRenderer = $this->getMock(
			't3lib_PageRenderer',
			array('addExtDirectCode'), array(), '', FALSE, FALSE, FALSE
		);

		/** @noinspection PhpUndefinedMethodInspection */
		$pageRenderer->expects($this->once())
			->method('addExtDirectCode');
