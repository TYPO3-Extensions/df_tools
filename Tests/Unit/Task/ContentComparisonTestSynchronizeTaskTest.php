...
/**
 * Test case for class Tx_DfTools_Task_ContentComparisonTestSynchronizeTask.
 *
 * @author Stefan Galinski <sgalinski@df.eu>
 * @package df_tools
 */
class Tx_DfTools_Task_ContentComparisonTestSynchronizeTaskTest extends Tx_DfTools_ExtBaseConnectorTestCase {
	/**
	 * @var Tx_DfTools_Task_ContentComparisonTestSynchronizeTask
	 */
	protected $fixture;
	...
	public function setUp() {
		...
		$this->fixture = $this->getMockBuilder($this->buildAccessibleProxy('Tx_DfTools_Task_ContentComparisonTestSynchronizeTask'))
