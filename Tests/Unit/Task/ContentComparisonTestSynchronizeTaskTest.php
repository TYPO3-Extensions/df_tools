...
use SGalinski\DfTools\Task\BackLinkTestTask;
use SGalinski\DfTools\Task\ContentComparisonTestSynchronizeTask;
...
/**
 * Class ContentComparisonTestSynchronizeTaskTest
 */
class ContentComparisonTestSynchronizeTaskTest extends ExtBaseConnectorTestCase {
	/**
	 * @var \SGalinski\DfTools\Task\ContentComparisonTestSynchronizeTask
	 */
	protected $fixture;
	...
	public function setUp() {
		...
		$this->fixture = $this->getMockBuilder($this->buildAccessibleProxy('SGalinski\DfTools\Task\ContentComparisonTestSynchronizeTask'))
	...
	public function executeCallsTheExtBaseController() {
		$this->addMockedExtBaseConnector('ContentComparisonTest', 'updateAllTestContents');
