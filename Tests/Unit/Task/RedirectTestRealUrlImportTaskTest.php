...
/**
 * Class RedirectTestRealUrlImportTaskTest
 */
class RedirectTestRealUrlImportTaskTest extends ExtBaseConnectorTestCase {
	/**
	 * @var \SGalinski\DfTools\Task\RedirectTestRealUrlImportTask
	 */
	protected $fixture;
	...
	public function setUp() {
		...
		$this->fixture = $this->getMockBuilder($this->buildAccessibleProxy('SGalinski\DfTools\Task\RedirectTestRealUrlImportTask'))
	...
	public function executeCallsTheExtBaseController() {
		$this->addMockedExtBaseConnector('RedirectTest', 'importFromRealUrl');
