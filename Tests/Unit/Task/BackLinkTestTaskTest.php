...
/**
 * Class BackLinkTestTaskTest
 */
class BackLinkTestTaskTest extends ExtBaseConnectorTestCase {
	/**
	 * @var \SGalinski\DfTools\Task\BackLinkTestTask
	 */
	protected $fixture;
	...
	public function setUp() {
		...
		$this->fixture = $this->getMockBuilder($this->buildAccessibleProxy('SGalinski\DfTools\Task\BackLinkTestTask'))
	...
	public function executeCallsTheExtBaseController() {
		$this->addMockedExtBaseConnector('BackLinkTest', 'runAllTests', array(), array('records' => array()));
