...
use SGalinski\DfTools\Task\LinkCheckTask;
...
/**
 * Test case for class Tx_DfTools_Task_LinkCheckTask.
 *
 * @author Stefan Galinski <sgalinski@df.eu>
 * @package df_tools
 */
class LinkCheckTaskTest extends ExtBaseConnectorTestCase {
	/**
	 * @var \SGalinski\DfTools\Task\LinkCheckTask
	 */
	protected $fixture;
	...
	public function setUp() {
		...
		$this->fixture = $this->getMockBuilder($this->buildAccessibleProxy('SGalinski\DfTools\Task\LinkCheckTask'))
	...
	public function executeCallsTheExtBaseController() {
		$this->addMockedExtBaseConnector('LinkCheck', 'runAllTests', array(), array('records' => array()));
