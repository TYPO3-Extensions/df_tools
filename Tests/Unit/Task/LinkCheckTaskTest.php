 ...
 * @package df_tools
 */
class Tx_DfTools_Task_LinkCheckTaskTest extends Tx_DfTools_ExtBaseConnectorTestCase {
	/**
	 * @var Tx_DfTools_Task_LinkCheckTask
	 */
	protected $fixture;
	...
	public function setUp() {
		...
		$this->fixture = $this->getMockBuilder($this->buildAccessibleProxy('Tx_DfTools_Task_LinkCheckTask'))
