 ...
 * @package df_tools
 */
class Tx_DfTools_Task_ContentComparisonTestTaskTest extends Tx_DfTools_ExtBaseConnectorTestCase {
	/**
	...
	public function setUp() {
		...
		$this->fixture = $this->getMockBuilder($this->buildAccessibleProxy('Tx_DfTools_Task_ContentComparisonTestTask'))
