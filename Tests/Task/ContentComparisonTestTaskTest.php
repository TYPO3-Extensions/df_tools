...
/**
 * Test case for class Tx_DfTools_Task_ContentComparisonTestTask.
 *
 * @author Stefan Galinski <sgalinski@df.eu>
 * @package df_tools
 */
class Tx_DfTools_Task_ContentComparisonTestTaskTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_DfTools_Task_ContentComparisonTestTask
	 */
	protected $fixture;
	...
	public function setUp() {
		...
		$proxy = $this->buildAccessibleProxy('Tx_DfTools_Task_ContentComparisonTestTask');
	...
	public function executeCallsTheExtBaseController() {
		$this->addMockedExtBaseConnector('ContentComparisonTest', 'runAllTests', array('records' => array()));
