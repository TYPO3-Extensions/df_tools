 ...
 * @package df_tools
 */
class Tx_DfTools_Task_LinkCheckTaskTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		...
		$proxy = $this->buildAccessibleProxy('Tx_DfTools_Task_LinkCheckTask');
	...
	public function executeCallsTheExtBaseController() {
		$this->addMockedExtBaseConnector('LinkCheck', 'runAllTests', array('records' => array()));
