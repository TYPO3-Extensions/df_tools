 ...
 * @package df_tools
 */
class Tx_DfTools_Task_LinkCheckSynchronizeTaskTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		...
		$proxy = $this->buildAccessibleProxy('Tx_DfTools_Task_LinkCheckSynchronizeTask');
