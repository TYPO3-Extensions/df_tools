 ...
 * @package df_tools
 */
class Tx_DfTools_Task_BackLinkTestTaskTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		...
		$proxy = $this->buildAccessibleProxy('Tx_DfTools_Task_BackLinkTestTask');
	...
	public function executeCallsTheExtBaseController() {
		$this->addMockedExtBaseConnector('BackLinkTest', 'runAllTests', array('records' => array()));
